        ...
        <div className="flex items-center justify-between pt-4 border-t border-dark-green/10 dark:border-light-green/20">
          ...
          {project.isDeploy && project.liveSite && (
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className={`inline-flex items-center gap-2 text-sm font-medium text-dark-green dark:text-light-green hover:underline focus:outline-none focus:ring-2 focus:ring-dark-green dark:focus:ring-light-green focus:ring-offset-2 rounded ${!(project.clientProject || project.projectType === "client") && project.code ? '' : 'ml-auto'}`}
            >
              <span>Live Demo</span>
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
